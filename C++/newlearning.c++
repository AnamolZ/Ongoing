...
int main(){
    ...
    int quantity,price,no_of_tables;char wood_selected;

    line1="====================================";
    line2="----------------";

    cout<<"\t"<<endl<<line1<<endl<<"Italian Woods Furniture Company"<<endl<<line1;
    cout<<endl<<"Enter P for Pine, O for Oak or M for Mahagany: ";cin>>wood_selected;
    cout<<"How many tables do you want : ";cin>>no_of_tables;
    cout<<endl<<" Wood Selected\t\t"<<left<<"  No of Tables\t\t   "<<left<<"Total cost\t"<<endl;
    cout<<line2<<"\t"<<left<<line2<<"\t"<<left<<line2<<endl;
    
    switch(wood_selected)
    {
    case 'P':price = no_of_tables*100;break;
    case 'O':price = no_of_tables*225;break;
    case 'M':price = no_of_tables*310;break;
    default:cout<<"Invalid Input";break;
    }

    cout<<"\t"<<wood_selected<<"\t\t\t"<<left<<no_of_tables<<"\t\t    "<<left<<"$"<<price<<"\t"
    <<endl<<endl<<"Thank You For Visiting us."<<endl;
    cout<<line1;
    return 0;
}
